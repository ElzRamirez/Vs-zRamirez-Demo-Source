...
class StatsCounter extends TextField
{
	...
	**/
	...
	private function onEnter(_)
	{
		...
		if (curState.startsWith('options.') || curState.startsWith('editors.') || curState.startsWith('achievements.')) 
		{
		...
		if (visible)
		{
			...
			#else
			memoryMegas = truncateFloat((MemoryUtil.getMemoryfromProcess() / (1024 * 1024)) * 10, 3);
